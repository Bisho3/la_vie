...
class AllFormusCard extends StatefulWidget {
  AllFormusCard({Key? key, required this.cubit, required this.index})
      : super(key: key);
  final LavieCubit cubit;
  final int index;

  @override
  State<AllFormusCard> createState() => _AllFormusCardCardState();
}

class _AllFormusCardCardState extends State<AllFormusCard> {
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                            focusedBorder: OutlineInputBorder(
                              borderSide:
                                  BorderSide(color: HexColor('#1ABC00')),
